	...
	public static function execute( $params ) {
		...
		if ( isset( $params['options']['sites'] ) ) {
			...
			foreach ( ai1wmme_get_sites( $params ) as $site ) {
				...
				$mysql->set_table_where_query( ai1wm_table_prefix( $site['BlogID'] ) . 'options', sprintf( "`option_name` NOT IN ('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s')", AI1WM_ACTIVE_PLUGINS, AI1WM_ACTIVE_TEMPLATE, AI1WM_ACTIVE_STYLESHEET, AI1WM_STATUS, AI1WM_SECRET_KEY, AI1WM_AUTH_USER, AI1WM_AUTH_PASSWORD, AI1WM_BACKUPS_LABELS, AI1WM_SITES_LINKS ) );
