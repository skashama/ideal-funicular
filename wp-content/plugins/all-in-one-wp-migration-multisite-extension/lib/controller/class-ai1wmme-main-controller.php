...
class Ai1wmme_Main_Controller {
	...
	public function ai1wm_commands() {
		if ( is_multisite() ) {
			...
			add_filter( 'ai1wm_export', 'Ai1wmme_Export_Enumerate_Tables::execute', 120 );
			...
			remove_filter( 'ai1wm_export', 'Ai1wm_Export_Enumerate_Tables::execute', 120 );
			...
			remove_filter( 'ai1wm_import', 'Ai1wm_Import_Plugins::execute', 340 );
