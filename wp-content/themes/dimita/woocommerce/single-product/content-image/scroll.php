		...
		<div class="row">
			...
			<div class="<?php echo esc_attr(dimita_image_single_product()->class_image); ?>">
				<div class="scroll-image">
					...
					<div class="image-additional slick-carousel" data-asnavfor=".image-thumbnail" data-columns4="1" data-columns3="1" data-columns2="1" data-columns1="1" data-columns="1" data-nav="true" <?php echo esc_attr(dimita_image_single_product()->class_data_image); ?>>
						<?php
						$attributes = array(
							'id'						=> "image", 	
							'title'                   => $image_title,
