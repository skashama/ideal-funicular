...
<div class="container">
	<div class="category-posts row">
		...
		<?php endif; ?>			
		<div class="cate-post-content <?php echo esc_attr($sidebar_blog); ?> <?php if(is_active_sidebar('sidebar-blog')){ echo esc_attr(dimita_get_class()->class_blog_content); }else{ echo "col-xl-12 col-lg-12 col-12"; } ?>">
