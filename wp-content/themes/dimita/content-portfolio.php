	...
	<div class="row">
		...
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 content-right">
			...
			<div class="portfolio-content">
				<?php 
					$show_post_title = dimita_get_config('portfolio-title',true);
					if ($show_post_title){
						if ( is_single() ){
				...
				<div class="portfolio-infomation">
					...
					<div class="post-date">
						<strong><?php echo esc_html__("Date","dimita") ?></strong>
						<span class="entry-date"><?php echo dimita_time_link(); ?></span>
					</div>
					<?php if($portfolio){ ?>
					<div class="categories">
						<strong><?php echo esc_html__("Categories","dimita") ?></strong>
					...
					<?php } ?>
					<?php if(dimita_get_config('show_share')) : ?>
					<div class="entry-single">
						<?php if ( shortcode_exists( 'social_share' ) ) : ?> 
						<div class="entry-social-share">
							<strong><?php echo esc_html__("share",'dimita') ?></strong>
