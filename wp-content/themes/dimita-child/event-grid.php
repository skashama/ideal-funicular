...
<article id="post-<?php esc_attr(the_ID()); ?>" <?php post_class($class); ?>>
	<div class="entry-post card">
		...
		<p class="post-excerpt"><?php the_field('event_description'); ?></p>	
		...
		?>
		<a class="read-more" href="<?php echo esc_url( $link_url ) ?>"><?php echo esc_html( $link_title ); ?></a>
		<?php endif; ?>
	</div>
</article><!-- #post-## -->